...
//
//     // эффект при вводе символа в поисковой строке:
//     useEffect(() => searchValue.length !== 0 ?
//         allUsers.map(u => {
//             if (searchValue.toLowerCase() === u.name.substring(0, searchValue.length).toLowerCase()) {
//                 newUsers.push(u)
//                 setModeSearch(true)
//                 setSearchPeople(newUsers)
//             }
...
//                  setModeSearch(false)
//                  :
//                  api.getSearchUsers(1, "").then(data => {
//                      setModeSearch(true)
//                      setAllUsers(data.newUsers)
//                      data.newUsers.map(u => {
//                          if (searchValue.toLowerCase() === u.name.substring(0, searchValue.length).toLowerCase()) {
//                              newUsers.push(u)
//                              setModeSearch(true)
